...
export default function DefinePage() {
  ...
  const { updateSession, generatePrompts, isLoading } = useCreativeFlow();
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await generatePrompts(sessionData.recipientName, sessionData.anchor, sessionData.occasion, sessionData.tone);
      setLocation('/gather');
    } catch (error) {
