...
export default function GatherPage() {
  ...
  useEffect(() => {
    ...
    if (!session.aiGeneratedPrompts || session.aiGeneratedPrompts.length === 0) {
      generatePrompts(
        session.recipientName, 
        session.anchor, 
        session.occasion || undefined, 
        session.tone || undefined
      );
    }
  }, [session, generatePrompts, setLocation]);
  ...
  const handleUpdateDescriptors = async (newDescriptors: string[]) => {
    await updateSession({ descriptors: newDescriptors } as any);
  };
          ...
          <div className="space-y-6">
            ...
            {isLoading ? (
              <div className="text-center py-8">
                ...
                <p className="text-slate-600">Generating personalized prompts...</p>
              </div>
            ) : (
                    ...
                    return (
                      <button
                        ...
                        onClick={() => {
                          ...
                          handleUpdateDescriptors(newDescriptors);
                        }}
